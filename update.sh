#!/usr/bin/env bash
# ClawHive OS updater (Linux, macOS, WSL)
# Usage:
...
# existing ~/.clawhive configuration and data.
...
echo "Your config and data in ~/.clawhive have been preserved."
