...
use claw10_icvs::{AgentPrompt, IcvsCompiler};
...
impl IcvsPromptRegistry {
    ...
    pub fn get_role_prompt(&mut self, role: &str) -> Result<Vec<AgentPrompt>, claw10_icvs::IcvsError> {
    ...
    pub fn get_lifecycle_prompt(
        &mut self,
        lifecycle: &str,
    ) -> Result<Vec<AgentPrompt>, claw10_icvs::IcvsError> {
