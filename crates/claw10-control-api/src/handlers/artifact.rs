...
use claw10_domain::{AgentId, ArtifactId, TaskId};
...
fn to_response(artifact: &claw10_domain::Artifact) -> ArtifactResponse {
    ArtifactResponse {
...
pub async fn list_artifacts(
    ...
    let artifacts = if let Some(task_id) = query.task_id {
        ...
        let all: Vec<(String, claw10_domain::Artifact)> = state
            .kv_store
